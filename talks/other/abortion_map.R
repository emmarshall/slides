...
ggplot(map_data,aes(x=long, y=lat, group=group))+
  ...
  labs(title="Where Abortion Is Prohibited",
       caption=" Post-Dobbs abortion bans /n Data as of June 2023 (Guttmacher Institute)")+
  theme_void()+
...
ggsave("~/docs/em-slides/talks/comps-proposal-2023-09-20/images/nyt_abortion_map.jpeg", height=6, width=6)