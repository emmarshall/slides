...
::: {.info-box .fragment .fade-out}
"Psych majors" vs. "Psych professionals" distinction is about ability to [GENERATE]{.highlight} and [EVALUATE]{.highlight} new knowledge
:::
...
![](images/scales.jpeg){.fragment .fade-up .absolute bottom="0" left="50" width="350" height="300"}

![](images/line.png){.fragment .fade-up .absolute bottom="0" right="50" width="350" height="300"}
...
::: {.info-box .fragment .fade-out}
Not everyone [produces]{.highlight} empirical research...
:::

![](images/anecdotes.jpg){fig-align="center" width="500" height="167"}

::: {.info-box .fragment .fade-in-then-semi-out}
But **ALL psychology** professionals need to be skilled research [consumers]{.highlight}
:::

## Evaluating Knowledge

::: info-box
Competent research [consumers]{.highlight} can...
:::
...
::: info-box
-   Most jobs (not just academia) require skills related to [producing]{.highlight} research and knowledge
...
::: info-box
-   If you understand the research process and can evaluate, integrate, and apply [empirical]{.highlight} research you will have:
...
![](images/p-value-statistics-meme.jpg){figure-align="center" fig-align="center" width="340"}
...
## Keep in Mind {background-color="black"}
